...
export const DARK_LEVELS = [
  { id: 'standard', label: 'Standard Dark', bg: '60 3% 15%', card: '60 3% 13%' },
  { id: 'deep', label: 'Deep Night', bg: '240 10% 3.9%', card: '240 10% 6%' },
  { id: 'oled', label: 'OLED Black', bg: '0 0% 0%', card: '0 0% 5%' },
];

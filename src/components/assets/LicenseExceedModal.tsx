...
import { getGlobalLimits } from '@/services/license'; // (lazy runtime usage if needed later)
      ...
      <DialogContent className='max-w-md'>
        <DialogHeader>
          <DialogTitle className='flex items-center gap-2 text-destructive'>
            <AlertTriangle className='h-5 w-5' /> Plan Limit Reached
          </DialogTitle>
          <DialogDescription>
            {info?.message || 'You have reached the asset allowance for your current plan.'}
          </DialogDescription>
        </DialogHeader>
        <div className='space-y-4 text-sm'>
          ...
          <div className='text-xs text-muted-foreground'>Need more capacity? Open a quick ticket so an admin can adjust this property allocation.</div>
        </div>
